...
export default function ShopPage() {
    ...
    const products: Product[] = [
        ...
        {
            id: "5",
            name: "Réduction Escape Game",
            description: "30% de réduction sur une session d'escape game chez EscapeMaster",
            price: 200,
            category: "partner",
            partnerSubCategory: "service",
            image: "/placeholder.svg?height=200&width=200",
            partner: "EscapeMaster",
            discount: 30,
            stock: 25,
        },
        {
            ...
            description: "Débloque instantanément un indice crypté lors d'une chasse",
            price: 100,
            category: "bonus",
            image: "/placeholder.svg?height=200&width=200",
            new: true,
        ...
        },
        {
            ...
            description: "Participation gratuite à un atelier créatif chez ArtSpace",
            price: 280,
            category: "partner",
            partnerSubCategory: "service",
            image: "/placeholder.svg?height=200&width=200",
        ...
        {
            id: "17",
            name: "Costume Halloween Spécial",
            description: "Costume exclusif pour votre avatar pendant la saison d'Halloween",
            price: 400,
            category: "event",
            image: "/placeholder.svg?height=200&width=200",
            featured: true,
        ...
        {
            id: "19",
            name: "Pack Anniversaire Lootopia",
            description: "Pack spécial pour célébrer l'anniversaire de Lootopia avec des objets exclusifs",
            price: 500,
            category: "event",
            image: "/placeholder.svg?height=200&width=200",
            featured: true,
        ...
        {
            id: "20",
            name: "Carte Collector Édition Limitée",
            description: "Carte collector numérotée avec avantages exclusifs",
            price: 750,
            category: "event",
            image: "/placeholder.svg?height=200&width=200",
            new: true,
