    ...
    return (
        <div className="flex min-h-screen w-full items-center justify-center p-4 md:p-8">
            <div className="w-full max-w-5xl overflow-hidden rounded-3xl bg-white p-6 shadow-xl md:p-8">
                <div className="mb-8 flex flex-col items-center justify-between border-b border-gray-100 pb-6 md:flex-row">
                        ...
                        {Array.from({ length: totalTabs }).map((_, index) => (
                            <div key={index} className="flex items-center">
                                ...
                                ${index + 1 === currentTab
                                            ...
                                            : index + 1 < currentTab
                                                ? "bg-blue-50 text-blue-200 hover:bg-blue-300"
                                ...
                                {index < totalTabs - 1 && (
                                    <div className={`mx-2 h-1 w-8 ${index + 1 < currentTab ? "bg-blue-200" : "bg-gray-200"}`}></div>
                                )}
                            </div>
                        ))}
                    </div>
                    ...
                    {currentTab === 3 && (
                        <div className="flex justify-center mt-4">
                            <button
                                ...
                                className="rounded-md bg-blue-200 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-300"
                            >
                                Envoyer la demande
                            </button>
                        </div>
                ...
                <div className="flex justify-between border-t border-gray-100 pt-6">
                    <button
                        type="button"
                        onClick={prevTab}
                        className={`rounded-md border border-gray-100 px-4 py-2 text-sm font-medium text-blue-200 shadow-sm hover:bg-gray-50 ${currentTab === 1 ? "invisible" : ""}`}
                    >
                        Précédent
                    </button>
                    ...
                    <button
                        type="button"
                        onClick={nextTab}
                        className={`rounded-md bg-blue-200 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-300 ${currentTab === 3 ? "invisible" : ""}`}
                    >
                        Suivant
                    </button>
                </div>
