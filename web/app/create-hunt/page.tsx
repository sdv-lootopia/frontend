...
import { MapPin, Crown, Plus, Trash2 } from "lucide-react"
import { HuntStorage, type HuntStep, type HuntMap } from "@/lib/hunt-storage"
        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
            ...
            <Tabs defaultValue="basic" className="space-y-6">
                <TabsList className="grid w-full grid-cols-4 bg-sand-50">
                    ...
                    <TabsTrigger value="maps" className="data-[state=active]:bg-sand-200 data-[state=active]:text-sand-600">
                        Cartes
                    </TabsTrigger>
